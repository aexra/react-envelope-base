...
export const ImageAuthForm = ({ onBadLogin }) => {
    const [isLoginForm, setForm] = useState(true);
    
    return (
        <VBoxPanel gap={'20px'} className={css.panel}>
            {isLoginForm ? <ImageLoginForm onBadLogin={onBadLogin}/> : <ImageRegisterForm onRegister={() => setForm(true)}/>}
